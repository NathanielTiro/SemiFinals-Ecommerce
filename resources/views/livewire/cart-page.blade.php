          ...
          <table class="w-full">
            ...
            <tbody>
              ...
              <tr wire:key='{{ $item['product_id'] }}'>
                ...
                <td><button wire:click='removeItem({{ $item['product_id'] }})'class="bg-slate-300 border-2 border-slate-400 rounded-lg px-3 py-1 hover:bg-red-500 hover:text-white hover:border-red-700"><span wire:loading.remove wire:target='removeItem({{ $item['product_id'] }})'>Remove</span><span wire:loading>Removing...</span></button></td>
              </tr>
              @empty
                <tr>
